...
var fx = function () {
    ...
    function T(b, c, d) {
        ...
        a.lensBlur2 = a.lensBlur2 || (new l(null, e + "void main(){vec4 color=(sample(delta0)+2.0*texture2D(texture1,texCoord))/3.0;gl_FragColor=pow(color,vec4(power));}")).textures({
            texture1: 1
        });
        e = [];
        for (var f = 0; f < 3; f++) {
        ...
        c.prototype.uniforms = function (f) {
            ...
            for (var g in f) if (f.hasOwnProperty(g)) {
                ...
                if (h !== null) {
                    ...
                    else throw 'attempted to set uniform "' + g + '" to invalid value ' + (i || "undefined").toString();
                }
            }
            return this
        };
