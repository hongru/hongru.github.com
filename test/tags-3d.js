...
var Tags3D = function() {
    ...
    init.prototype = {
        ...
        bindEvent: function() {
            ...
            //     _this.mouseX = ev.pageX - (_this.container.offsetLeft + _this.container.offsetWidth / 2);
            //     _this.mouseY = ev.pageY - (_this.container.offsetTop + _this.container.offsetHeight / 2);
